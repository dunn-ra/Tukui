...
local function Shared(self, unit)
	...
	--[-[ unitframe sizes
	ufwidth = TukuiDB.Scale(ui.playerwidth)
	...
	if (unit == "player" or unit == "target") then
		...
		if (db.unitcastbar == true) then
			...
			if db.separatecastbar ~= true then
				...
				if unit == "player" then
					castbar:SetWidth(ufwidth*1.05)
					castbar:SetPoint("BOTTOM", InvTukuiActionBarBackground, "TOP", TukuiDB.Scale(0), TukuiDB.Scale(55))
				elseif unit == "target" then
					castbar:SetWidth(ufwidth*1.1)
					castbar:SetPoint("BOTTOM", UIParent, "BOTTOM", 0, TukuiDB.Scale(220))
				end
			end			
			...
			if db.cbicons == true and db.separatecastbar == true then
				...
				if unit == "player" then
					castbar.button:SetHeight(btnsize*1.2)
					castbar.button:SetWidth(btnsize*1.2)
					castbar.button:SetPoint("TOP", 0, (hpheight+btnsize*1.2))
				elseif unit == "target" then
					castbar.button:SetHeight(btnsize*1.5)
					castbar.button:SetWidth(btnsize*1.5)
					castbar.button:SetPoint("TOP", 0, (hpheight+btnsize))
				end
...
if TukuiDB.lowversion then
	player:SetPoint("BOTTOMLEFT", InvTukuiActionBarBackground, "TOPLEFT", TukuiDB.Scale(TukuiDB.buttonsize+TukuiDB.buttonspacing+7), TukuiDB.Scale(55))
else
	--player:SetPoint("BOTTOMLEFT", InvTukuiActionBarBackground, "TOPLEFT", TukuiDB.Scale(36), TukuiDB.Scale(57))
	player:SetPoint("BOTTOMLEFT", InvTukuiActionBarBackground, "TOPLEFT", TukuiDB.Scale(4), TukuiDB.Scale(55))
end
...
if TukuiDB.lowversion then
	target:SetPoint("BOTTOMRIGHT", InvTukuiActionBarBackground, "TOPRIGHT", TukuiDB.Scale(-(TukuiDB.buttonsize+TukuiDB.buttonspacing+3)), TukuiDB.Scale(55))
else
	target:SetPoint("BOTTOMRIGHT", InvTukuiActionBarBackground, "TOPRIGHT", TukuiDB.Scale(-6), TukuiDB.Scale(55))
end
