...
local function Local(o)
	...
	if o == "TukuiConfigUIbagsslot" then o = TukuiL.option_bags_slot end
	...
	--
	if o == "TukuiConfigUIunitframesname" then o = TukuiL.option_unitframes_name end
	if o == "TukuiConfigUIunitframesclasscolorcastbar" then o = TukuiL.option_unitframes_classcolorcastbar end
	if o == "TukuiConfigUIunitframesseparatecastbar" then o = TukuiL.option_unitframes_separatecastbar end
	if o == "TukuiConfigUIunitframesshowpercentage" then o = TukuiL.option_unitframes_showpercentage end
	if o == "TukuiConfigUIunitframespowerbar" then o = TukuiL.option_unitframes_powerbar end
	if o == "TukuiConfigUIunitframespercentage" then o = TukuiL.option_unitframes_percentage end
	...
	if o == "TukuiConfigUItooltiprecountconfig" then o = TukuiL.option_tooltip_recountconfig end
	...
	if o == "TukuiConfigUIothersraidutility" then o = TukuiL.option_others_raidutility end
	if o == "TukuiConfigUIotherspmarkbar" then o = TukuiL.option_others_markbar end
	--
	if o == "TukuiConfigUIothersmarkbar" then o = TukuiL.option_others_markbar end
	...
	if o == "TukuiConfigUIactionbartranslucid" then o = TukuiL.option_actionbar_translucid end
	...
	if o == "TukuiConfigUIchatpanelwidth" then o = TukuiL.option_chat_panelwidth end
	...
	if o == "TukuiConfigUIclasstimerbgalpha" then o = TukuiL.option_classtimer_bgalpha end
	if o == "TukuiConfigUIclasstimericonposition" then o = TukuiL.option_classtimer_iconposition end
	if o == "TukuiConfigUIclasstimerspark" then o = TukuiL.option_classtimer_spark end
	if o == "TukuiConfigUIclasstimerseparator" then o = TukuiL.option_classtimer_separator end
	if o == "TukuiConfigUIclasstimertextmargin" then o = TukuiL.option_classtimer_textmargin end
