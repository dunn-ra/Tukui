...
TukuiL.option_general_classcolor = "Enable classcolored theme"
...
--
TukuiL.option_merchant_sellmisc = "Auto sell specific items (check merchant.lua for filters)"
 
-- bags
TukuiL.option_bags = "Bags"
TukuiL.option_bags_enable = "Enable all-in-one bag"
--
TukuiL.option_bags_moveable = "Enable moveable bags"
TukuiL.option_bags_slot = "Number of column slots to display on the bags"
...
TukuiL.option_datatext_bg = "Enable Battleground Stats (NYI)"
...
TukuiL.option_datatext_curency = "Currency tracker"
--
...
--
TukuiL.option_unitframes_name = "Display name on player unit frame"
TukuiL.option_unitframes_classcolorcastbar = "Enable class colored castbars"
TukuiL.option_unitframes_separatecastbar = "Enable castbars outside unitframes"
TukuiL.option_unitframes_showpercentage = "Only show mana/health percentage on unitframes"
TukuiL.option_unitframes_powerbar = "Enable soulshard/holypower manager for Paladin and Warlock"
TukuiL.option_unitframes_percentage = "Show only percentage for mana and health values"
TukuiL.option_unitframes_combobar = "Enable combobar manager for Feral Druid and Rogues"
TukuiL.option_unitframes_classcolor = "Enable classcolored panels"
...
TukuiL.option_tooltip_recountconfig = "Set tooltip to display above recount"
 
-- others
TukuiL.option_others = "Others"
TukuiL.option_others_bg = "Enable Auto-Release in battleground"
TukuiL.option_others_raidutility = "Toggle menu for raid leaders"
TukuiL.option_others_markbar = "Toggle menu with raid markers"
...
TukuiL.option_others_markbar = "Enable MarkBar (easy access to raid icon markers)"
...
TukuiL.option_actionbar_rn = "Number of action bars on right (0, 1 or 2)"
--
TukuiL.option_actionbar_cubes = "Display cubes on left and right side of the action bar to toggle addons (ex: Recount)"
TukuiL.option_actionbar_translucid = "Enable translucid panels"
...
TukuiL.option_chat_background = "Enable chat frame background"
TukuiL.option_chat_panelwidth = "Chat frame size"

-- classtimer
TukuiL.option_classtimer = "Classtimer"
TukuiL.option_classtimer_enable = "Enable classtimer"
TukuiL.option_classtimer_layout = "Layout style (1 to 4)"
TukuiL.option_classtimer_bgalpha = "Choose background alpha (0 to 1)"
TukuiL.option_classtimer_iconposition = "Set spell icon position (0 left,	1 right, 2 outside, 4 hide)"
TukuiL.option_classtimer_spark = "Show spark"
TukuiL.option_classtimer_separator = "Show cast separator"
TukuiL.option_classtimer_textmargin = "Text and time text margins"
