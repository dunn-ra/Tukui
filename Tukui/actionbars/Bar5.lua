...
for i= 1, 12 do
	...
	if i == 1 then
		if TukuiCF.actionbar.rightbars > 1 then
			...
			b:SetPoint("TOPLEFT", TukuiActionBarBackgroundRight, "TOPLEFT", 0, TukuiDB.Scale(4), TukuiDB.Scale(-4))
		end
	else
		if TukuiCF.actionbar.rightbars > 1 then
...
-- hide it if needed
if (TukuiCF.actionbar.bottomrows == 1 and TukuiCF.actionbar.rightbars < 2) or (TukuiCF.actionbar.bottomrows == 2 and TukuiCF.actionbar.rightbars < 2) then
	TukuiBar5:Hide()
end