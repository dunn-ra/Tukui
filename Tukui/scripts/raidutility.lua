-- RaidUtility by Elv22
if not TukuiCF["others"].raidutility == true then return end
...
ShowButton:SetAttribute("_onclick", [=[
 if select(5, self:GetPoint()) > 0 then
	 ...
	 self:GetParent():SetPoint("TOP", UIParent, "TOP", -300, -3)
	 self:ClearAllPoints()
	 self:SetPoint("TOP", UIParent, "TOP", -300, -103)
 else
	 self:GetParent():ClearAllPoints()
