--[[ From .toc
## Interface: 40000
## Title: |cffC495DDTukui Class Timer|r
## Author: Kryso
## Version: 2.17
## RequiredDeps: Tukui
--]]
...
if ( TukuiCF and TukuiCF["media"] and TukuiCF["media"]["font"] and TukuiCF["media"]["nfont"] ) then
	...
	STACKS_FONT = { TukuiCF["media"]["nfont"], 12, "OUTLINE" };
else
...
local PLAYER_BAR_COLOR = TukuiCF["media"].bordercolor;
...
local TRINKET_BAR_COLOR = TukuiCF["media"].healthdeficit;
...
do
	...
	CreateFramedTexture = function( parent )
		...
		background:SetTexture(TukuiCF["media"].healthcolor);
...
do
	...
	CreateAuraBarFrame = function( dataSource, parent )
		...
		border:SetPoint( "TOPLEFT", result, "TOPLEFT", -2, 2 );
		border:SetPoint( "BOTTOMRIGHT", result, "BOTTOMRIGHT", 2, -2 );
		result.border = border;		
...
if ( LAYOUT == 1 ) then
	...
	local yOffset = 6;
	if ( playerClass == "DEATHKNIGHT" or playerClass == "ROGUE" or playerClass == "SHAMAN" or playerClass == "PALADIN" or playerClass == "DRUID" or playerClass == "WARLOCK") then
		yOffset = yOffset + 4;
	end
	frame:SetPoint( "BOTTOMLEFT", oUF_Tukz_player, "TOPLEFT", 0, yOffset + 4 );
	frame:SetPoint( "BOTTOMRIGHT", oUF_Tukz_player, "TOPRIGHT", 0, yOffset + 4 );
	frame:Show(); 
elseif ( LAYOUT == 2 ) then
	...
	if ( playerClass == "DEATHKNIGHT" or playerClass == "ROGUE" or playerClass == "SHAMAN" or playerClass == "PALADIN" or playerClass == "DRUID" or playerClass == "WARLOCK") then
		playerFrame:SetPoint( "BOTTOMLEFT", oUF_Tukz_player, "TOPLEFT", 0, yOffset + 4 );
		playerFrame:SetPoint( "BOTTOMRIGHT", oUF_Tukz_player, "TOPRIGHT", 0, yOffset + 4 );
	else
...
elseif ( LAYOUT == 4 ) then
	...
	targetFrame:SetPoint( "BOTTOMLEFT", oUF_Tukz_target, "TOPLEFT", 0, 5 + ( 25 * 3 ) );
	targetFrame:SetPoint( "BOTTOMRIGHT", oUF_Tukz_target, "TOPRIGHT", 0, 5 + ( 25 * 3 ) );
	targetFrame:Show();
else
