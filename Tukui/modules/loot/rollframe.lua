...
local function CreateRollButton(parent, ntex, ptex, htex, rolltype, tiptext, ...)
	...
	txt:SetFont(C["media"].uffont, 11, "OUTLINE")
...
local function CreateRollFrame()
	...
	bind:SetFont(C["media"].uffont, 11, "OUTLINE")
	frame.fsbind = bind

	local loot = frame:CreateFontString(nil, "ARTWORK")
	loot:SetFont(C["media"].uffont, 11, "OUTLINE")
...
label:SetFont(C["media"].uffont, 11, "OUTLINE")
