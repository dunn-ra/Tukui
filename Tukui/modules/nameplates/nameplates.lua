...
local function CreateVirtualFrame(parent, point)
	...
	parent.backdrop:SetPoint("TOPLEFT", point, "TOPLEFT", -noscalemult*2, noscalemult*2)
	parent.backdrop:SetPoint("BOTTOMRIGHT", point, "BOTTOMRIGHT", noscalemult*2, -noscalemult*2)
	parent.backdrop:SetTexture(unpack(C["media"].backdropcolor))

	parent.bordertop = parent:CreateTexture(nil, "BORDER")
	parent.bordertop:SetPoint("TOPLEFT", point, "TOPLEFT", -noscalemult*1, noscalemult*1)
	parent.bordertop:SetPoint("TOPRIGHT", point, "TOPRIGHT", noscalemult*1, noscalemult*1)
	...
	parent.borderbottom:SetPoint("BOTTOMLEFT", point, "BOTTOMLEFT", -noscalemult*1, -noscalemult*1)
	parent.borderbottom:SetPoint("BOTTOMRIGHT", point, "BOTTOMRIGHT", noscalemult*1, -noscalemult*1)
	...
	parent.borderleft:SetPoint("TOPLEFT", point, "TOPLEFT", -noscalemult*1, noscalemult*1)
	parent.borderleft:SetPoint("BOTTOMLEFT", point, "BOTTOMLEFT", noscalemult*1, -noscalemult*1)
	...
	parent.borderright:SetPoint("TOPRIGHT", point, "TOPRIGHT", noscalemult*1, noscalemult*1)
	parent.borderright:SetPoint("BOTTOMRIGHT", point, "BOTTOMRIGHT", -noscalemult*1, -noscalemult*1)
