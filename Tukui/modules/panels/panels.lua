...
TukuiBar1:SetPoint("BOTTOMRIGHT", UIParent, "BOTTOM", 0, pheight+2)
TukuiBar1:SetWidth((T.buttonsize * 12) + (T.buttonspacing * 12))
...
TukuiBar2:SetPoint("BOTTOMLEFT", TukuiBar1, "BOTTOMRIGHT", 0, 0)
...
TukuiBar3:SetPoint("BOTTOMLEFT", TukuiBar1, "TOPRIGHT", -((T.buttonsize * 6) + (T.buttonspacing * 6)), 0)
...
TukuiBar4:SetPoint("RIGHT", UIParent, "RIGHT", -10, 0)
...
if C["actionbar"].cubes == true then
	...
	cuberight:CreatePanel("Transparent", 10, 10, "TOPLEFT", TukuiBar2, "TOPRIGHT", 0, 0)
