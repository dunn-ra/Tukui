...
local fontsize = 20 -- Map Font Size
...
local SmallerMapSkin = function()
	...
	WorldMapQuestShowObjectives:Point("BOTTOMRIGHT", WorldMapButton, "BOTTOMRIGHT", -12, 12)
	...
	WorldMapQuestShowObjectivesText:Point("RIGHT", WorldMapQuestShowObjectives, "LEFT", 0, 1)
