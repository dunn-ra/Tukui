...
TukuiWatchFrameAnchor:SetFrameLevel(16)
TukuiWatchFrameAnchor:SetHeight(16)
...
TukuiWatchFrameAnchor.text = T.SetFontString(TukuiWatchFrameAnchor, C.media.uffont, 11)
...
TukuiWatchFrameAnchor:Point("TOPRIGHT", UIParent, -200, -270)
...
local function setup()	
	...
	WatchFrameCollapseExpandButton:FontString("text", C.media.font, 14)
