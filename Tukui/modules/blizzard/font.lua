...
TukuiFonts:SetScript("OnEvent", function(self, event, addon)
	...
	SetFont(NumberFont_Outline_Large,           NUMBER, 14, "OUTLINE")
	...
	SetFont(QuestFont_Large,                    NORMAL, 13)
	SetFont(SystemFont_Large,                   NORMAL, 14)
	...
	SetFont(SystemFont_Shadow_Large,            NORMAL, 14)
