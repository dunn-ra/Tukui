...
if not C.unitframes.fader then return end
...
local conditions = setmetatable({
	...
	PlayerMaxHealth = function(obj, unit) return unit and UnitHealth("player") == UnitHealthMax("player") end,
	UnitMaxMana = function(obj, unit) return unit and not UnitIsDeadOrGhost(unit) and UnitMana(unit) == UnitManaMax(unit) end,
	PlayerMaxMana = function(obj, unit) return unit and UnitMana("player") == UnitManaMax("player") end,
	Dead = function(obj, unit) return unit and UnitIsDeadOrGhost("player") end,
	Stealth = IsStealthed,
	Flying = IsFlying,
	Resting = IsResting,
