...
local function Shared(self, unit)
	...
	power:Point("TOPLEFT", health, "BOTTOMLEFT", 0, -T.mult)
	power:Point("TOPRIGHT", health, "BOTTOMRIGHT", 0, -T.mult)
	...
	if C["unitframes"].showsymbols == true then
		...
		RaidIcon:Height(16*T.raidscale)
		RaidIcon:Width(16*T.raidscale)
	...
	ReadyCheck:SetPoint('RIGHT', self, 'LEFT')
